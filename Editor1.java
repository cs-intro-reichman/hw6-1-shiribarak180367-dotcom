 ...
 * Runigram.java. The program recieves two command-line arguments: a string
 * representing the name of the PPM file of a source image, and one of the
 * strings "fh", "fv", or "gs". The program creates and displays a new image
 * which is either the horizontally flipped version of the source image ("fh"),
 * or the vertically flipped version of the source image ("fv"), or the
 * grayscaled version of the source image ("gs"). For example, to create a
 * grayscale version of thor.ppm, use: java Editor1 thor.ppm gs
 */
